...
public class AeroplaneController : MonoBehaviour
{
    ...
    [SerializeField] private GameObject immobilizedObj; // which objects should be inactive while immobilized.
    ...
    [HideInInspector]public bool m_Immobilized = false;   // used for making the plane uncontrollable, i.e. if it has been hit or crashed.
    ...
    private void CalculateForwardSpeed()
    {
        ...
        ForwardSpeed = Mathf.Max(0, localVelocity.z+2f);
    }
    ...
    private void ControlThrottle()
    {
        ...
        if (m_Immobilized)
        {
            ...
            AirBrakes = true;
            ForwardSpeed = 0;
            immobilizedObj.SetActive(false);
        }else{
            if(immobilizedObj){
                immobilizedObj.SetActive(true);
            }
        }
    ...
    private void CalculateTorque()
    {
        ...
        var sm = Vector3.zero;
        sm += 0.1f*transform.right;
        sm += 0.1f*transform.up;
        sm += 0.1f*transform.forward;
        sm += m_BankedTurnAmount*m_BankedTurnEffect*transform.up;
        ...
        // m_Rigidbody.AddTorque(torque*ForwardSpeed*m_AeroFactor+2*torque);
